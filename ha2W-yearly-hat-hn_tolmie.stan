...
parameters{
    real<lower=0.01,upper=0.99> xmax;           // X value at which maximum latent productivity occurs, 0-1 bounded
    real<lower=0.5,upper=0.99> b;                          // Shaping parameter, 0-1 bounded
    real<lower=0.001,upper=0.25> LPmax;            // Maximum latent productivity
